...
const features = [
  ...
  {
    feature: "Automated Blog Posting",
    free: "1 Post Demo",
    pro: "Up to 30 a month",
  },
...
const Plans = () => {
  ...
  // Conditional Pricing
  const [proPrice, setProPrice] = useState({ month: 29, year: 278.4 });
  const [freePrice, setFreePrice] = useState({ month: 0.0, year: 0.0 });
    ...
    <div className="">
      ...
      <div className="max-w-xl mx-auto px-4 lg:pt-8 pb-8 text-center">
        ...
        <h1 className="text-[2.5rem] md:text-[3rem] font-semibold text-gray-900 mb-4">
          Find the <span className="text-indigo-600">Perfect Plan</span> for
          Your Needs
        </h1>
        ...
        <div className="flex justify-center gap-3 items-center mb-6">
          ...
          <p className="text-black text-sm">
            Annual pricing
            <span className="text-primary text-sm"> (save 20%)</span>
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-[90%] mx-auto md:w-full">
        ...
        <div className="mb-8 px-4">
          ...
          <h1 className="text-3xl font-semibold text-gray-900 mb-4">
            ...
            <span className="text-indigo-600">
              Select a Dexter Plan That Matches{" "}
            </span>{" "}
            Your Business Goals!
          </h1>
          <p className="text-gray-700 text-lg">
            Take control of your SEO strategy with a plan that's tailored to
            your business. From content creation to AI-driven SEO analytics and
            strategies, Dexter helps you stay ahead every step of the way,
            effortlessly.
          </p>
        </div>
        ...
        <div className="border border-gray-200 bg-white rounded-lg shadow-sm p-4 ">
          ...
          <div className="flex items-center bg-layer px-4 py-4 border rounded-lg justify-between">
            ...
            <div className="flex flex-col items-end">
              <p className="text-2xl font-bold text-gray-900">
                ${isToggled ? freePrice.year : freePrice.month}
              </p>
          ...
          <div className="">
            ...
            <p className="text-gray-600 text-sm mb-8">
              Start your journey with Dexter AI, and make smarter SEO decisions
              for your strategy—no matter where you’re starting. With simple,
              user-friendly interfaces, Dexter helps you create a strong
              foundation for success without any technical know-how.
            </p>
          </div>

          {/* Button Section */}
          <button
            className="border w-full text-[#475467]flex items-end justify-center py-2 px-4 rounded-lg font-medium"
            onClick={getStarted}
          >
            Get Started Now
          </button>
        ...
        <div className="border border-gray-200 bg-white rounded-lg shadow-sm p-4 ">
          ...
          <div className="flex items-center bg-layer px-4 py-4 border rounded-lg justify-between">
            ...
            <div className="flex flex-col items-end">
              <p className="text-2xl font-bold text-gray-900">
                ${isToggled ? proPrice.year : proPrice.month}
              </p>
              <p className="text-gray-600  text-sm">
                /{isToggled ? "year" : "month"}
              </p>
          ...
          <div className="">
            <p className="text-[#7A8EAC] text-sm my-4">What is included ?</p>
            <p className="text-gray-600 text-sm mb-8">
              Take control of your online growth with features like content
              creation, blog posting, SEO analytics, and personalized
              recommendations. This plan helps business owners scale by
              simplifying your SEO strategy, so you can focus on growing your
              business.
            </p>
          </div>
      ...
      <div className="mx-auto mt-12 ">
        <table className="w-[90%] mx-auto md:w-full text-left border-collapse overflow-hidden ">
          <thead className="border-b text-xl font-semibold">
            <tr>
              <th className="px-4 py-2 text-[#0F182A] font-semibold">
                Features Comparison
              </th>
              <th className="px-4 py-2 text-primary font-semibold">
                Free Plan
              </th>
              <th className="px-4 py-2 text-primary font-semibold">
                Professional Plan
