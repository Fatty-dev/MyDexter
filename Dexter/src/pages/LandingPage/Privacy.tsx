...
const Privacy = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 mb-[5rem] font-normal text-[#475467] leading-relaxed">
      ...
      <p className="mt-[1rem] font-normal text-[#475467]">
      ...
      <section className="mb-8 mt-10">
        ...
        <p className="mb-4">
          Dolor enim eu tortor urna sed dui nulla. Aliquam vestibulum, nulla
        ...
        <p>
          Eti nisl in eleifend sed nisl. Pulvinar at orci, proin imperdiet
      ...
      <section>
        ...
        <ol className="list-decimal pl-6 space-y-2">
          <li>Lectus id dui vitae porttitor enim gravida morbi.</li>
          <li>
            Et turpis posuere semper feugiat volutpat elit, ultricies
            suspendisse.
          </li>
          <li>
