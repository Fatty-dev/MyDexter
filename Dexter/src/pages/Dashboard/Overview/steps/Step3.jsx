  ...
  return (
    <div className="bg-white rounded-lg shadow-lg border border-gray-300 p-4">
      <div className="flex items-start  gap-4 ">
        ...
        <div className="text-[#181f2f] flex flex-col gap-4 w-[60%] font-semibold">
          <div>
            ...
            <p className="text-[#8e9fb8]  text-[10px]">
      ...
      <div className="ml-[3.3rem]">
        <button className="text-white flex gap-2 items-center  bg-[#6d68fb] max-md:justify-center md:justify-center text-[12px] p-3 mt-4  lg:w-[70%]  max-md:w-full  rounded-md">
