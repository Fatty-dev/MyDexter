...
const PostHistory = () => {
  ...
  return (
    <div className="p-4 mb-12 bg-white rounded-lg shadow`">
      <div className="flex items-start justify-between max-md:flex-col max-md:gap-4 max-md:items-start mb-6 border-b border-gray-300 pb-4 ">
      ...
      <div className="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 gap-6 p-6 rounded-lg bg-[#f5f7f9]">
