    ...
    <div className="lg:mt-2 md:mt-2 max-md:mt-16 mb-8 relative bg-white border border-gray-300 h-fit shadow-md rounded-lg p-4 lg:w-[84%] md:w-[84%] max-md:w-full ">
      <form>
        <div className="flex flex-col gap-5">
          ...
          <div className="flex items-center justify-between text-sm text-gray-400 lg:flex-row max-md:flex-col max-md:items-start max-md:gap-4 md:gap-4 md:flex-col md:items-start">
            ...
            <div className="flex  items-start gap-4 text-[#4b586b]  text-sm">
