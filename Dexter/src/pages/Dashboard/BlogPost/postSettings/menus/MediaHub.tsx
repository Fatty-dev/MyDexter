      ...
      <form className="flex flex-col gap-4">
          ...
          <div className="space-y-6 lg:w-1/2">
            <div className="flex gap-6">
              <div className="flex flex-col w-1/2 gap-3">
                <label
                  htmlFor="aiImages"
                  className="text-#545a67] flex items-center text-sm gap-2 md:text-sm"
                >
                  AI images
                </label>
                <Controller
        ...
        <div className="flex gap-6">
          <div className="relative flex flex-col w-1/2 gap-3">
            <label
              ...
              className="text-#545a67] md:gap-1 lg:gap-3 max-md:gap-12 flex items-center text-sm  gap-2"
            >
            ...
            <Controller
              ...
              render={({ field }) => (
                <div>
                  ...
                  />
                  <div className="absolute max-md:top-0 max-md:right-4 lg:top-0 lg:right-4 max-md:text-sm lg:text-sm md:right-0 md:top-[0.8px] md:text-sm">
        ...
        <div className="flex items-start gap-2 w-[90%] text-sm">
          ...
          <label
            ...
            className="text-#545a67] lg:w-[75%] text-sm max-md:w-full"
          >
            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  ...
                  <option value="Alternate image and video">
        ...
        <div className="flex items-start gap-2 w-[90%] text-sm">
          ...
          />
          <label
            htmlFor="strictPlacement"
            className="text-#545a67] lg:w-[75%] text-sm max-md:w-full"
          >
            All media element will be placed strictly under the headings. I
            disabled , the AI will decide and find the best placement.
          </label>
        </div>
      </form>
    </div>
