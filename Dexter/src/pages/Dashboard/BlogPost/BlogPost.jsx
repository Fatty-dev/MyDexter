...
const BlogPost = () => {
  ...
  return (
    <div className="w-[90%] mx-auto mt-[1.5rem]">
      ...
      <div className="bg-[#344054] flex flex-col lg:flex-row gap-6 lg:gap-4 p-4 items-start lg:items-center justify-between text-white rounded-md mb-6">
        ...
        <div className="flex flex-col sm:flex-row lg:gap-4 gap-3 whitespace-nowrap lg:w-[43%] w-full">
          <button
