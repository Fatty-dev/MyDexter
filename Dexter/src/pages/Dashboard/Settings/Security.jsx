...
const Security = () => {
 ...
 <div className="bg-white shadow-md mt-4 max-md:mt-24 mb-8 rounded-lg p-6">
      ...
      <div className="flex justify-between max-md:flex-col md:flex-col md:gap-4 lg:flex-row max-md:gap-4 p-6 text-[#85858d]">
        ...
        {/* Button Fix */}
        <button className="self-start border whitespace-nowrap border-[#908dfc] rounded-lg p-2 text-[#908dfc] hover:bg-[#908dfc] hover:text-gray-900 transition-all duration-300">
          Log out all
        </button>
      </div>
    </div>
