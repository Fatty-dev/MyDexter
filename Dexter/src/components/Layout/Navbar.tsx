    ...
    <nav className="container mx-auto flex flex-col lg:flex-row justify-between items-center pt-6 md:pt-8 py-4 bg-white">
      ...
      >
        ...
        <li className="block lg:hidden mb-4">
          <button
            className="w-full bg-primary text-white px-4 py-2 rounded transition duration-200 hover:bg-opacity-80"
            onClick={handleTry}
          >
            Try Dexter for free
          </button>
      ...
      <button
        className="hidden lg:block bg-primary text-white px-4 py-2 rounded transition duration-200 hover:bg-opacity-80"
        onClick={handleTry}
      >
        Try Dexter for free
      </button>
